...
task_id='foodpics';
study_dir='/home/maureen/adak';								        % main study directory
...
output_dir=fullfile(bids_dir,'derivatives',['adak_' task_id '_TEST']);	    % analysis output directory for fmriprep 3mm data
